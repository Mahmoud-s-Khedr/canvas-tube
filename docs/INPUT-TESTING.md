# Linux Wayland & XP-Pen Tablet Testing Guide

This guide details the hardware verification, driver setup, and manual testing procedures for **CanvasTube** running on **Fedora Linux**, **Wayland**, and the **XP-Pen Deco 01 V3** drawing tablet.

---

## 1. Hardware & System Profile
...
## 4. Live Stylus & Pointer Inspector Walkthrough

CanvasTube includes a built-in developer **Stylus & Pointer Inspector** specifically engineered to diagnose tablet driver behavior on Wayland.
...
2. **Pressure Gauge**:
   ...
   - Confirm pressure transitions smoothly without stepped quantization.
...
## 5. Wayland Desktop Calibration & Multi-Monitor Setup
...
## 6. Manual QA Checklist for Release Testing
...
| **TC-06: Architecture Stencils** | Search "Database" and click icon | Stencil SVG appears centered in canvas viewport | [ ] |
